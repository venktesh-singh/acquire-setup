import { Button, Chip, Icon, IconButton,Grid, styled, TableBody, TableCell, TableHead, TablePagination, TableRow, } from "@mui/material";
...
import { getGlassacphplfixingemp,} from "app/redux/actions/GlassAcpHplFixingAction";
...
const EmpGlassAcpHplFixingList = () => {
    ...
    const glassacphplfixingLists = useSelector(state => state.glassacphplfixing.empglassacphplfixingList)

    useEffect(() => {
        const user = JSON.parse(localStorage.getItem('user'));
        if (user) {
            dispatch(getGlassacphplfixingemp(user.user.first_name + " " + user.user.last_name));
        }
    }, [dispatch]);
    ...
    return (
        <>
            ...
            <Container>
                ...
                <Box width="100%">
                    {user === "Employee" ?
                        <Button variant="contained" color="primary" style={{ marginBottom: "10px" }}>
                            <Link color="primary" variant="contained" to="/glassacphplfixing/add-glassacphplfixing">
                                Add Glass Fixing
                            </Link>
                        </Button>
                        : null}
                ...
                <SimpleCard title="All GlassAcpHplFixing">
                                                ...
                                                <StylPopUp key={index} sx={{ mb: 2, background: `linear-gradient(87deg,#11cdef 0,#1171ef 100%)!important` }}>
                                                    <Grid container spacing={2}>
                                                        ...
                                                        <Grid item sm={2} style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                                            ...
                                                            <Link color="primary" variant="contained" to="/glassacphplfixing/edit-glassacphplfixing" state={subscriber}>
                                                                <IconButton
...
export default EmpGlassAcpHplFixingList;
